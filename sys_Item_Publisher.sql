...
CREATE TABLE `Item_Publisher` (
  ...
  KEY `Item_ID` (`Item_ID`),
  CONSTRAINT `item_publisher_ibfk_1` FOREIGN KEY (`Item_ID`) REFERENCES `Item` (`Item_ID`),
  CONSTRAINT `item_publisher_ibfk_2` FOREIGN KEY (`Publisher_ID`) REFERENCES `Publisher` (`Publisher_ID`)
